...
enum {
  /* $B5:8291 uploads ROM $EE:0088 at SPC $0560. The music scheduler
   * branch at SPC $07AB is the two-byte mute at ROM offset $2E02D3.
...
int Dkc2RestoreSpcMusicPolicy(struct Apu *apu, const uint8_t *verified_rom,
                              size_t rom_size) {
